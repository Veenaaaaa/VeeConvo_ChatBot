...
1. Clone the repository:
   ...
   ```
   git clone https://github.com/alexbenko/VeeConvo.git
   ```
...
3. Run command at root
   ```
   docker build -t VeeConvo .
   ```
4. Start docker
   ```
   docker run -p 8000:8000 VeeConvo
   ```
