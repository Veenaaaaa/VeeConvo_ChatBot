        ...
        >
            ...
            {contextFile && (
                <Box>
                    ...
                    <Tooltip title="VeeConvo remembers the information from this file and can continue to answer questions on it. Use /pdf to continue asking questions.">
                        <Chip
...
const ChatMessage = ({ message }: ChatMessageProps) => {
    ...
    const senderName = isAIMessage ? "VeeConvo" : "You";
    const avatarSrc = isAIMessage ? `/veeconvo.webp` : `cat.webp`;
    ...
    return (
        <Box
            sx={{
                ...
                backgroundColor: isAIMessage ? "#FF69B4" : "pink",
